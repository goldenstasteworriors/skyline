...
// 不带MCU的摄像头
//--------------------------------------------------------------------------------------------------
#define SOFT_IIC_SCL_PIN		(USART_SCL_RX_Pin)
#define SOFT_IIC_SCL_PORT		(USART_SCL_RX_GPIO_Port)
#define SOFT_IIC_SDA_PIN		(USART_SDA_TX_Pin)
#define SOFT_IIC_SDA_PORT		(USART_SDA_TX_GPIO_Port)
